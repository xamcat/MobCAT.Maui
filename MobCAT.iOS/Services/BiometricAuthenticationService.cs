...
namespace MobCAT.iOS.Services
{
    public class BiometricAuthenticationService : IBiometricAuthenticationService
    {
        ...
        public Task<AuthenticationResult> AuthenticateAsync(string alertMessage = null)
        {
            ...
            {
                Debug.WriteLine("[BiometricAthenticationService] Authentication not available on this device");
            ...
            else
            {
                ...
                Debug.WriteLine($"This device doesn't have authentication configured: {authError.ToString()}");
        ...
        public BiometricType AvailableBiometricType
        {
            get
            {
                ...
                Debug.WriteLine($"[BiometricAuthenticationService] Local Auth context failed with error: {authError}");
